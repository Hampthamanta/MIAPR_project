...
private:
    ...
    std::vector<std::pair<Point, Point>> tree_edges_;

    rclcpp_lifecycle::LifecyclePublisher<visualization_msgs::msg::Marker>::SharedPtr tree_pub_;

    rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>::SharedPtr steps_pub_;
...
#endif  // NAV2_RRTSTAR_PLANNER__RRT_STAR_PLANNER_HPP_
